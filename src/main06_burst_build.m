function hmm_input_output = main06_burst_build(project,DropboxFolder,varargin)
...
load([DataPath 'hmm_input_output_w' num2str(w) '_K' num2str(K) '_f' num2str(fluo_dim) 'D_p' num2str(protein_dim) 'D.mat'],'hmm_input_output')
n_features = 0;
% iterate
...
save([DataPath 'hmm_input_output_w' num2str(w) '_K' num2str(K) '_f' num2str(fluo_dim) 'D_p' num2str(protein_dim) 'D_dt.mat'],'hmm_input_output')
